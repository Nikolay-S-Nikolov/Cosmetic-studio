...
import Cosmetic_studio.accounts.menagers
...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            managers=[
                ('objects', Cosmetic_studio.accounts.menagers.StudioUserManager()),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('preferred_name_nickname', models.CharField(help_text='Please enter preferred name/nickname for personalized communication', max_length=150)),
